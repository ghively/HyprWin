...
// ═══════════════════════════════════════════════════════════════════════════════
// AI_AGENT_STOP: MONOCLE_LAYOUT — Single-visible-window stack.
// Behavior notes:
//   1. All windows get the full workspace rect (stacked in Z-order).
//   2. focused_idx determines which window is conceptually "on top".
//   3. The actual Z-order is managed by the platform layer (SetWindowPos).
//   4. Smart gaps have no effect (single window always gets full area).
// ═══════════════════════════════════════════════════════════════════════════════
...
impl MonocleLayout {
    ...
    pub fn calculate(
        ...
        let focused_idx = focused_idx.min(windows.len() - 1);
        ...
        results.push((windows[focused_idx], final_rect));
