...
// ═══════════════════════════════════════════════════════════════════════════════
// AI_AGENT_STOP: GRID_LAYOUT — Equal rows/columns distribution.
// To modify grid dimensions:
//   1. calculate_grid_dimensions() finds optimal (rows, cols) minimizing waste.
//   2. Windows are distributed in row-major order.
//   3. Each cell gets equal width/height minus gaps.
//   4. Remainder pixels are distributed round-robin.
// ═══════════════════════════════════════════════════════════════════════════════
