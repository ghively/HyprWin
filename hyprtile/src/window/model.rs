...
// ═══════════════════════════════════════════════════════════════════════════════
// AI_AGENT_STOP: WINDOW_STATE_MACHINE — Five-state window lifecycle.
// Before adding new states or transitions:
//   1. States: TILING, FLOATING, MAXIMIZED, FULLSCREEN, MINIMIZED.
//   2. toggle_float() saves previous position in floating_rect.
//   3. toggle_fullscreen() preserves previous_state for restoration.
//   4. minimize() sets state but does NOT remove from workspace.
//   5. should_tile() returns true only for TILING + visible + not fullscreen.
// ═══════════════════════════════════════════════════════════════════════════════
