...
// ═══════════════════════════════════════════════════════════════════════════════
// AI_AGENT_STOP: WINDOW_FILTER — Single source of truth for window eligibility.
// Before modifying filter logic:
//   1. This is the ONLY place that defines which windows are managed.
//   2. platform/window.rs::should_manage_window() should delegate here.
//   3. New window types (e.g. new UWP variants) need tests in filter.rs.
//   4. All filter functions must be pure (no side effects, deterministic).
// ═══════════════════════════════════════════════════════════════════════════════
