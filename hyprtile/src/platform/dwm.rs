...
// Before adding new DWM features:
//   1. Check is_border_color_supported() — many features need Windows 11+.
//   2. DWMWINDOWATTRIBUTE constants vary by Windows version.
//   3. Undocumented APIs (set_border_width) may break on Windows updates.
//   4. Always have a fallback path for unsupported OS versions.
//   5. Test on both Windows 10 (1903+) and Windows 11.
// ═══════════════════════════════════════════════════════════════════════════════
